...
> "However, they are not easy to come by. The raw stones must be carefully examined, and only a precious few contain the power needed to cast spells. Once a suitable stone is found, it can only be used once before its power is exhausted, crumbling into dust or shattering into useless fragments."
