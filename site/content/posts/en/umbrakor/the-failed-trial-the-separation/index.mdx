...
Drusniel stood frozen while bodies moved past—successful candidates toward one door, failures toward another. His legs wouldn't move. His mind kept reaching for where the connection should be, testing the place where response should live.
...
"It worked," he whispered, voice cracking. "You felt it. I *know* you felt it—I saw your face when you reached. You had it, Drus. I don't—I don't understand—"

His voice broke. Not analysis. Just confusion. Just fear.
...
No. That wasn't it. Drusniel had *felt* the blessing approach. He hadn't imagined it. And Annariel's face had confirmed the inconsistency—that confusion, that fear.
...
He could still recall the sequence—reach, resistance, warmth, response—and the way it had broken. It hadn't felt like failure. Failure was reaching and finding nothing from the start.

This was reaching, feeling warmth approach, and then—no response. No feedback. As if the process had completed normally on his end and simply produced no result.
