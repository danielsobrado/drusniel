...
Drusniel stood frozen while bodies moved past—successful candidates toward one door, failures toward another. His legs wouldn't move. His mind replayed the sequence, checking each step for where the response should have occurred.
