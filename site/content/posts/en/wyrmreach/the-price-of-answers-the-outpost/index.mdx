...
![Ancient drow outpost between two basalt ridges](./drow-outpost_sora.jpg)
...
![Szoravel at the stone workbench preparing instruments](./szoravel-workbench_sora.jpg)
...
![Nyxara enters the outpost and assesses the chamber](./nyxara-enters-outpost_sora.jpg)
...
![Two powers facing each other with Drusniel between them](./two-powers_sora.jpg)
...
![Drusniel sits across from Szoravel to begin](./drusniel-sits_sora.jpg)
