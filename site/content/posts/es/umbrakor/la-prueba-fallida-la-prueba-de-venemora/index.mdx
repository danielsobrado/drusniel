...
featured: false
language: es
counterpart_path: site/content/posts/en/umbrakor/the-failed-trial-the-test-of-venemora/index.mdx
counterpart_title: "The Failed Trial: The Test of Venemora"
type: Main
order: 128

--- 

##  | La Prueba Fallida: La Prueba de Venemora

--- 

Las puertas de la cámara se abrieron con un gemido. El conteo de Drusniel titubeó —diecisiete, dieciocho— y perdió el hilo de sus latidos por completo.
...
Sus piernas se movieron. El suelo de obsidiana se sentía demasiado liso bajo sus pies, demasiado frío. Contó sus pasos —uno, dos, tres, cuatro, cinco, seis, siete— hasta que alcanzó la plataforma.
...
Drusniel no escuchó el resto. Estaba contando sus latidos de nuevo, aferrándose a esa pequeña disciplina como a una cuerda en la oscuridad.
...
**[Fin de UMB-M-003 — continúa en UMB-M-004: Secretos y Sombras]**