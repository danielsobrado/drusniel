...
![Bote de remos en el Mar de Pesadillas](./rowboat-on-nightmare-sea_sora.jpg)
...
![Achicando agua incorrecta que vuelve una y otra vez](./bailing-wrong-water_sora.jpg)
...
![Remando mientras cuenta para no quebrarse](./rowing-while-counting-breaks_sora.jpg)
...
<video controls playsInline preload="metadata" poster="./air-magic-jerk-forward_sora.jpg" width="100%">
	<source src="./Drunsiel_Waves.mp4" type="video/mp4" />
</video>
...
![Algo rozando el casco desde abajo](./something-brushes-the-hull_sora.jpg)
