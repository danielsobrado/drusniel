...
![Drusniel observa a los Caparazones de Fuego durante horas sobre el campo de placas](./watching-the-scorchshells_sora.jpg)
...
![Los viales extraídos de la mochila, uno ámbar y otro verde pálido, brillando bajo la luz volcánica](./the-vials-from-the-pack_sora.jpg)
...
![Entrada estrecha de túnel de Caparazones de Fuego, apenas transitable para una persona de lado](./scorchshell-tunnel-entrance_sora.jpg)
...
![Momento de convergencia: escritos de caverna, viales y rutas de Caparazones alineándose en un solo plan](./the-convergence-moment_sora.jpg)
...
![Drusniel contando de nuevo los intervalos mientras observa el patrón de los Caparazones de Fuego](./counting-the-intervals_sora.jpg)
