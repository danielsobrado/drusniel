# POV Voice Guidelines for Drusniel Content
...
| Tier | Order Range | Purpose | Voice |
|------|------------|---------|-------|
| **Lore** | 101-199 (EN), 1101-1199 (ES) | World texture | Fragmentary, compiled, disputed |
| **Prequel** | 200-299 (EN), 1200-1299 (ES) | Character glimpses | Limited POV, local stakes |
| **Main** | 300+ (EN), 1300+ (ES) | Core narrative | Drusniel's direct experience |
...
- Treat prophecies or metaphysics as verifiable
...
❌ "The Theocracy moves toward inevitable dominance."
✅ "Syrael copied the figures carefully. The numbers pleased the Council. That was enough."
```
...
- Show successful preparation for real threats
...
❌ "Chaos gnawed at the world."
✅ "Stone cracked where it never had before."
```

---

## POV Voice by Author Type
